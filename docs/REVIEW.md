...
> **Draft in my own words for you to personalise (Vatsalya).** It reflects the actual
> decisions and trade-offs made; edit the tone, the time estimates, and anything you'd
> phrase differently before submitting. Supporting detail lives in
> [`DECISION_LOG.md`](DECISION_LOG.md) and [`DATA_QUALITY_REPORT.md`](DATA_QUALITY_REPORT.md).
